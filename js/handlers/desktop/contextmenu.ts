...
function register1() {
  ...
  document.querySelectorAll('#table .table-item').forEach(item => item.addEventListener('contextmenu', e => handle(item as HTMLElement, e as MouseEvent)))
}
 ...
 * */
export function handle(item: HTMLElement, e: MouseEvent) {
