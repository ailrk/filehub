...
, cryptonite, data-default, directory, effectful, file-embed
...
, network-uri, optparse-applicative, process, QuickCheck, random
, req, servant, servant-client, servant-conduit, servant-lucid
, servant-multipart, servant-server, split, string-interpolate
, suspend, temporary, text, time, timers, tomland, transformers
, unliftio, unordered-containers, uri-encode, uuid, vault, vector
, wai, wai-app-static, wai-extra, warp, zip
}:
mkDerivation {
  pname = "filehub";
  version = "0.1.3.0";
  ...
  libraryHaskellDepends = [
    ...
    optparse-applicative random servant servant-client servant-conduit
    servant-lucid servant-multipart servant-server split
